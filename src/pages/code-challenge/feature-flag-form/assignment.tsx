...
import { flagFormOptions, useAppForm } from './your-codes/form'
import { stringifyFlag } from './your-codes/libs/serializer'
        ...
        <main className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <section className="space-y-5">
            <div className="bg-card p-5 rounded-xl border border-border shadow-sm">
              ...
              <p className="mb-4">
                ...
                ผู้ใช้ต้องสามารถเพิ่ม/ลดเงื่อนไขได้ และเห็นผลลัพธ์ JSON ทันที
              </p>
            ...
            <div className="bg-card p-6 rounded-xl border border-border shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground italic">
                    กำหนดได้ว่า Flag นี้จะคืนค่าเป็นอะไร (เช่น Variation A =
                    true, Variation B = false)
                  </p>
                </div>
          ...
          <section className="space-y-5">
            <div className="bg-slate-950 rounded-xl border border-border overflow-hidden">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed max-h-96 overflow-auto">
                <form.Subscribe selector={(s) => s.values}>
                  {(values) => (
                    <pre className="text-blue-300">{stringifyFlag(values)}</pre>
                  )}
                </form.Subscribe>
              </div>
            </div>
